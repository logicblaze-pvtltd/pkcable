...
<div id="user-modal" class="modal-shell hidden" aria-hidden="true">
    ...
    <div class="modal-card modal-card-lg">
        <div class="modal-header">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-500 dark:text-blue-400">Admin Form</p>
                <h2 id="modal-title" class="text-xl font-bold text-gray-900 dark:text-gray-100 mt-1">Add New Admin</h2>
            </div>
        ...
        <div class="modal-body space-y-4">
            ...
            <div>
                ...
                <input type="email" id="user-email" placeholder="admin@example.com" class="modal-input" autocomplete="email">
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Optional. Leave this field blank if you want the system to generate a password for you.</p>
            </div>
            ...
            <div>
                ...
                <textarea id="user-address" placeholder="Enter admin address" rows="3" class="modal-input resize-none"></textarea>
            </div>
        </div>

        <div class="modal-footer">
            <button id="cancel-modal-btn" class="modal-secondary-btn" type="button">Cancel</button>
            <button id="save-user-btn" class="modal-primary-btn" type="button">Save Admin</button>
        </div>
    </div>
</div>
...
<div id="delete-modal" class="modal-shell hidden" aria-hidden="true">
    ...
    <div class="modal-card modal-card-sm">
        <div class="modal-body text-center space-y-4">
            ...
            <div>
                <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Delete Admin?</h3>
                <p id="delete-message" class="text-gray-600 dark:text-gray-400 mt-2">This action cannot be undone. The admin record will be permanently deleted.</p>
            </div>
        </div>
        <div class="modal-footer">
...
<div id="view-modal" class="modal-shell hidden" aria-hidden="true">
    ...
    <div class="modal-card modal-card-lg">
        <div class="modal-header">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-500 dark:text-blue-400">Admin Preview</p>
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100 mt-1">Admin Details</h2>
            </div>
        ...
        <div class="modal-body space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="modal-detail-card">
                    <p class="modal-label">Admin ID</p>
                    <p id="view-id" class="modal-value">#A001</p>
                </div>
                <div class="modal-detail-card">
                ...
                <div class="modal-detail-card">
                    ...
                    <span id="view-role" class="inline-flex px-3 py-1 bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 rounded-full text-xs font-medium">Admin</span>
                </div>
                <div class="modal-detail-card">
