...
<div id="user-modal" class="modal-shell hidden" aria-hidden="true">
    ...
    <div class="modal-card modal-card-lg">
        <div class="modal-header">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-500 dark:text-blue-400">Manager Form</p>
                <h2 id="modal-title" class="text-xl font-bold text-gray-900 dark:text-gray-100 mt-1">Add New Manager</h2>
            </div>
        ...
        <div class="modal-body space-y-4">
            ...
            <div>
                ...
                <input type="email" id="user-email" placeholder="manager@example.com" class="modal-input" autocomplete="email">
            </div>
            ...
            <div>
                ...
                <textarea id="user-address" placeholder="Enter manager address" rows="3" class="modal-input resize-none"></textarea>
            </div>
        </div>

        <div class="modal-footer">
            <button id="cancel-modal-btn" class="modal-secondary-btn" type="button">Cancel</button>
            <button id="save-user-btn" class="modal-primary-btn" type="button">Save Manager</button>
        </div>
    </div>
</div>
...
<div id="delete-modal" class="modal-shell hidden" aria-hidden="true">
    ...
    <div class="modal-card modal-card-sm">
        <div class="modal-body text-center space-y-4">
            ...
            <div>
                <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Delete Manager?</h3>
                <p id="delete-message" class="text-gray-600 dark:text-gray-400 mt-2">This action cannot be undone. The manager record will be permanently deleted.</p>
            </div>
        </div>
        <div class="modal-footer">
...
<div id="view-modal" class="modal-shell hidden" aria-hidden="true">
    ...
    <div class="modal-card modal-card-lg">
        <div class="modal-header">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-500 dark:text-blue-400">Manager Preview</p>
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100 mt-1">Manager Details</h2>
            </div>
        ...
        <div class="modal-body space-y-5">
            <div class="flex justify-center">
                <div id="view-avatar" class="w-16 h-16 rounded-2xl bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 flex items-center justify-center font-bold text-2xl shadow-sm">
                    M
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="modal-detail-card">
                    <p class="modal-label">Manager ID</p>
                    <p id="view-id" class="modal-value">#M001</p>
                </div>
                <div class="modal-detail-card">
                ...
                <div class="modal-detail-card">
                    ...
                    <span id="view-role" class="inline-flex px-3 py-1 bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400 rounded-full text-xs font-medium">Manager</span>
                </div>
                <div class="modal-detail-card">
