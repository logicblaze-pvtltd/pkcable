                                    ...
                                    <tr class="subscription-row"
                                        ...
                                        <td class="hidden md:table-cell whitespace-nowrap">
                                            <div class="flex items-center gap-2 justify-center">
                                                <a href="subscriptions_history.php?user=<?= urlencode($row['user_id']) ?>" class="p-2 hover:bg-blue-100 dark:hover:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded transition-colors" title="View History">
